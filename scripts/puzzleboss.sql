...
INSERT INTO `config` VALUES
  ...
  ('SKIP_PUZZCORD', 'true'),
  ('STATUS_METADATA', '[{"name":"WTF","emoji":"☢️","text":"?","order":0},{"name":"Critical","emoji":"⚠️","text":"!","order":1},{"name":"Needs eyes","emoji":"👀","text":"E","order":2},{"name":"Being worked","emoji":"🙇","text":"W","order":3},{"name":"Under control","emoji":"🤝","text":"U","order":4},{"name":"New","emoji":"🆕","text":"N","order":5},{"name":"Grind","emoji":"⛏️","text":"G","order":6},{"name":"Waiting for HQ","emoji":"⌛","text":"H","order":7},{"name":"Abandoned","emoji":"🏳️","text":"A","order":8},{"name":"Solved","emoji":"✅","text":"*","order":9},{"name":"Unnecessary","emoji":"🙃","text":"X","order":10},{"name":"[hidden]","emoji":"👻","text":"H","order":99}]'),
...
CREATE TABLE `puzzle` (
  ...
  `status` enum('New','Being worked','Needs eyes','Solved','Critical','Unnecessary','WTF','Under control','Waiting for HQ','Grind','Abandoned','[hidden]') NOT NULL,
...
CREATE TABLE `round` (
  ...
  `drive_uri` varchar(255) DEFAULT NULL,
  `drive_id` varchar(100) DEFAULT NULL,
  `status` enum('New','Being worked','Needs eyes','Solved','Critical','Unnecessary','WTF','Under control','Waiting for HQ','Grind','Abandoned','[hidden]') NOT NULL DEFAULT 'New',
