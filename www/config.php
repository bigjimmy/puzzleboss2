...
$keyDescriptions = [
  ...
  'SERVICE_ACCOUNT_JSON' => 'Full contents of the Google service account JSON key file (preferred over SERVICE_ACCOUNT_FILE)',
  ...
  'WIKI_URL' => 'Base URL of the wiki AS REACHABLE FROM THE API CONTAINER, ending in /wiki/ (the indexer appends api.php). Must be an unauthenticated API listener: in the ECS deployment that is http://mediawiki.puzzleboss.local:8080/wiki/ (the no-OIDC robot listener). The public OIDC-protected URL and localhost will not work.',
