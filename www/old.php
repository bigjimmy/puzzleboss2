...
if ($user_network === 'MIT GUEST' || isset($_GET['wifi_debug'])) {
  ...
  <div class="error">
    ...
    Again, <strong>you will have a harder time participating in Hunt</strong> on this WiFi network! Continue at your own peril. <a href="../wiki/index.php/WiFi" target="_blank">See here for more info.</a>
  </div>
HTML;
} else {
  $wifi_warning = '';
